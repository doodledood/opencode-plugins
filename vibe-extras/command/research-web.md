...
Use web-researcher agents (defined in agents/web-researcher.md) for each research angle. **Launch agents in parallel** (single message with multiple agent invocations) to maximize efficiency.
...
4. **Launch 1-3 agents** for this wave (focused investigation)
   - Use web-researcher agents (defined in agents/web-researcher.md)
...
2. Use the web-researcher agent (defined in agents/web-researcher.md) with: "{query}"
