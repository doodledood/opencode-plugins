...
Use the codebase-explorer agent (defined in agents/codebase-explorer.md) with: "$ARGUMENTS"
...
Use codebase-explorer agents (defined in agents/codebase-explorer.md) for each angle. **Launch all agents in parallel** (single message with multiple agent invocations).
