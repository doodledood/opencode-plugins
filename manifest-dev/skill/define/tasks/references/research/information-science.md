...
- **Simple keyword searches retrieve only 28-40% of relevant indexed content** [PRIMARY: Walters; PRIMARY: Salvador-Olivan et al. 2019]. AI agents relying on single-query strategies systematically miss a majority of relevant sources — this is the single most consequential finding for AGENTS.md process improvement.
